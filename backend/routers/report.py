...
@router.post("/report")
def create_report(request: RtlRequest, email: str = Depends(get_current_user_email)):
...
def download_report(report_id: str, email: str = Depends(get_current_user_email)):
